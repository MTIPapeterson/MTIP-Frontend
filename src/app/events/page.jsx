      ...
      sanityData.map((e) => {
        return(
          <div className='max-w-[900px] grid md:grid-cols-5 bg-mt-blue-light rounded-md mb-[20px]' key={e.title} >
            <h1 className='ml-4 mr-4 md:mr-0 pt-4 mb-2 uppercase text-[24px] md:text-[32px] row-span-1 col-span-5 md:col-span-3 border-b-mt-blue-dark border-b-[1px] text-center md:text-left'>{e.title}</h1>
            <h1 className='mr-4 ml-4 md:ml-0 mb-2 pt-4 uppercase self-end text-[24px] text-mt-blue-dark row-span-1 col-span-5 md:col-span-2 text-center md:text-right border-b-mt-blue-dark md:border-b-[1px]'>{formatDate(e.date)}</h1>
            <div className='p-4 pt-2 pb-2 col-span-5 md:col-span-2 row-span-2 grid items-center justify-center w-full'>
